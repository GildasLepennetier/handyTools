...
#' @importFrom openxlsx createWorkbook addWorksheet writeData freezePane setColWidths addFilter saveWorkbook
#' @export
#' @examples
#' \dontrun{
#' export_xlsx(my_data, "name.xlsx", "sheetname")
#' }
#'
export_xlsx <- function(data, filename, sheet) {
	wb <- createWorkbook()
